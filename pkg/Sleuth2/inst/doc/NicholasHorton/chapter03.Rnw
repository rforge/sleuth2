...
The two-sided $p$-value is \Sexpr{print.pval(pval(t.test(lograin ~ Treatment, data=case0301)))} and the 95\% confidence interval is between \Sexpr{round(ttestlog$conf.int[1], 2)} and \Sexpr{round(ttestlog$conf.int[2], 2)}.
